...
var NeuralNetwork = (function () {
    ...
    NeuralNetwork.prototype.addNeuronToLayer = function (layerI) {
        if (layerI < -1 || layerI >= this.layers.length)
            throw new Error("addNeuronToLayer: invalid layer number: " + layerI);
        ...
        if (layerI == -1)
            this.numInputs++;
        else if (layerI == this.layers.length - 1)
            this.numOutputs++;
        else
